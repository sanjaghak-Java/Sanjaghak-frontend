...
function ProductDetail({ onAddToCart }) {
  const [mainImage, setMainImage] = useState("./src/assets/images.jpg");
  const thumbnails = ["images (1).jpg", "images (2).jpg", "images.jpg"];
    ...
    <div className="head-cart">
      <div className="product">
        <div className="icons-container">
          <Link>
            <img
              src="./src/assets/icons8-like-50.png"
              alt="like"
              className="like"
            />
          </Link>
        ...
        <div className="information">
          ...
          <h2 className="product-name">سامسونگgalaxy A53</h2>
          ...
          <div className="warranty">
            <img
              src="./src/assets/tools-wench-ruler.png"
              alt="warranty"
